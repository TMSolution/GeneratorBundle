...
class DoctrineCrudGenerator extends Generator
{
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $targetControllerName = sprintf(
            '%s\Controller\%s',
            $this->bundle->getNamespace(),
            $entityClass
        );
        
        $this->createNewAcl($targetControllerName);
        ...
        $this->renderFile('crud/controller.php.twig', $target, array(
            ...
            'format'            => $this->format,
            'target_controller_name' => $targetControllerName,
        ));
    }
    ...
    protected function createNewAcl($target)
    {
        $aclProvider = $this->container->get('security.acl.provider');
        $oid = new ObjectIdentity('class', $target);
        try{
            $acl = $aclProvider->createAcl($oid);
        }catch(\Exception $e) {
            throw new \Exception('ACL already exists, check acl entries (in acl_classes)!');
        }
